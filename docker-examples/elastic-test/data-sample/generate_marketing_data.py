...
def generate_marketing_data():
    ...
    return {
        ...
        "channel": random.choice([
            "Email", "Social Media", "Search", "Display", 
            "Video", "Affiliate", "Direct"
        ]),
        ...
        "status": random.choice([
            "Ativo", "Pausado", "Finalizado", "Agendado", "Cancelado"
        ]),
        "target_audience": random.choice([
            "Jovens", "Adultos", "Idosos", "Famílias", 
            "Profissionais", "Estudantes", "Empresários"
        ]),
        "campaign_type": random.choice([
            "Awareness", "Consideração", "Conversão", 
            "Retenção", "Reativação", "Branding"
        ]),
        "platform": random.choice([
            "Facebook", "Instagram", "Google", "LinkedIn", 
            "Twitter", "TikTok", "YouTube", "Email"
        ]),
